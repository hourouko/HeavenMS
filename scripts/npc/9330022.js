...
var hair = Array(32200 ,32190, 32210, 32230, 32240, 32250, 32260, 32270, 32280, 32290, 32300, 34420);
var hairnew = Array();
var face = Array(21000, 21001, 21002, 21003, 21004, 21005, 21006, 21007, 21008, 21009, 21010, 21011, 21012, 21013, 21014, 21016, 21017, 21018, 21019, 21020, 21021, 21022, 21024, 21025, 21026, 21027, 21028, 21029, 21030, 21031, 21036, 21038, 21041, 21042, 21043, 21044, 21045, 21048, 21049, 21050, 21051, 21052);
var facenew = Array();
var colors = Array();
		...
		if (status == 0) {
			...
			//} else {
				if(cm.getChar().getGender() == 1) {
					...
					cm.sendOk("Currently I am only serving females, but you should try Niki!");
					cm.dispose();
				}
			//}
		} else if (status == 1) {
